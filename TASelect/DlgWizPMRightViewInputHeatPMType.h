...
class CDlgWizardPM_RightViewInput_HeatingPMType : public CDlgWizardPM_RightViewInput_Base
{

public:
	enum { IDD = IDD_DLGWIZPM_RIGHTVIEWINPUT_HEATPMTYPE };

	CDlgWizardPM_RightViewInput_HeatingPMType( CWizardSelPMParams *pclWizardSelPMParams, CWnd *pclParent );

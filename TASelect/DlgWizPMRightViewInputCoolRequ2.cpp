...
CDlgWizardPM_RightViewInput_CoolingRequirement2::CDlgWizardPM_RightViewInput_CoolingRequirement2( CWizardSelPMParams *pclWizardSelPMParams, CWnd *pclParent )
	: CDlgWizardPM_RightViewInput_Base( pclWizardSelPMParams, CoolingRequirement2, IDD, pclParent )
{
	m_bButtonWaterMakeUpBreakTankState = false;
	m_bButtonWaterMakeUpDutyStby = false;
}

void CDlgWizardPM_RightViewInput_CoolingRequirement2::ApplyPMInputUserUpdated( bool bWaterCharUpdated, bool bShowErrorMsg )
{
...
BEGIN_MESSAGE_MAP( CDlgWizardPM_RightViewInput_CoolingRequirement2, CDlgWizardPM_RightViewInput_Base )
...
void CDlgWizardPM_RightViewInput_CoolingRequirement2::DoDataExchange( CDataExchange *pDX )
{
...
BOOL CDlgWizardPM_RightViewInput_CoolingRequirement2::OnInitDialog()
{
	if( NULL == m_pclWizardSelPMParams || NULL == m_pclWizardSelPMParams->m_pclSelectPMList 
			|| NULL == m_pclWizardSelPMParams->m_pclSelectPMList->GetpclPMInputUser() )
	{
	...
	SetMainTitle( TASApp.LoadLocalizedString( IDS_DLGWIZPM_RVIEWCOOLREQU2_MAINTITLE ) );
...
void CDlgWizardPM_RightViewInput_CoolingRequirement2::OnSize( UINT nType, int cx, int cy )
{
...
void CDlgWizardPM_RightViewInput_CoolingRequirement2::OnBnClickedWaterMakeUpBreakTank()
{
...
void CDlgWizardPM_RightViewInput_CoolingRequirement2::OnBnClickedWaterMakeUpDutyStby()
{
	if( NULL == m_pclWizardSelPMParams || NULL == m_pclWizardSelPMParams->m_pclSelectPMList || NULL == m_pclWizardSelPMParams->m_pclSelectPMList->GetpclPMInputUser() 
			|| NULL == m_pclWizardSelPMParams->m_pclSelectPMList->GetpclPMInputUser()->GetPMWQSelectionPreferences()  )
	{
...
void CDlgWizardPM_RightViewInput_CoolingRequirement2::OnEnSetFocusMaxWidth()
{
	m_ExtEditSizeMaxWidth.SetSel( 0, -1 );
	m_dMaxWidthSaved = m_ExtEditSizeMaxWidth.GetCurrentValSI();
}

void CDlgWizardPM_RightViewInput_CoolingRequirement2::OnEnSetFocusMaxHeight()
{
	m_ExtEditSizeMaxHeight.SetSel( 0, -1 );
	m_dMaxHeightSaved = m_ExtEditSizeMaxHeight.GetCurrentValSI();
}

void CDlgWizardPM_RightViewInput_CoolingRequirement2::OnKillFocusMaxWidth()
{
	if( NULL == m_pclWizardSelPMParams || NULL == m_pclWizardSelPMParams->m_pclSelectPMList 
			|| NULL == m_pclWizardSelPMParams->m_pclSelectPMList->GetpclPMInputUser() )
	{
...
void CDlgWizardPM_RightViewInput_CoolingRequirement2::OnKillFocusMaxHeight()
{
	if( NULL == m_pclWizardSelPMParams || NULL == m_pclWizardSelPMParams->m_pclSelectPMList 
			|| NULL == m_pclWizardSelPMParams->m_pclSelectPMList->GetpclPMInputUser() )
	{
...
LRESULT CDlgWizardPM_RightViewInput_CoolingRequirement2::OnUnitChange( WPARAM wParam, LPARAM lParam )
{
...
void CDlgWizardPM_RightViewInput_CoolingRequirement2::GetExtEditList( CArray<CExtNumEdit*> &arExtEditList )
{
	arExtEditList.Add( &m_ExtEditSizeMaxWidth );
	arExtEditList.Add( &m_ExtEditSizeMaxHeight );
}

void CDlgWizardPM_RightViewInput_CoolingRequirement2::InitToolTips( CWnd *pWnd )
{
...
void CDlgWizardPM_RightViewInput_CoolingRequirement2::_VerifyInputValues()
{

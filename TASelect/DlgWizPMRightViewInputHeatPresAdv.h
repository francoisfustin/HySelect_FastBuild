...
class CDlgWizardPM_RightViewInput_HeatingPressureAdvance : public CDlgWizardPM_RightViewInput_Base
{

public:
	enum { IDD = IDD_DLGWIZPM_RIGHTVIEWINPUT_HEATPRESADV };

	CDlgWizardPM_RightViewInput_HeatingPressureAdvance( CWizardSelPMParams *pclWizardSelPMParams, CWnd *pclParent );

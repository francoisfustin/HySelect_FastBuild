...
class CDlgWizardPM_RightViewInput_SolarPressureAdvance : public CDlgWizardPM_RightViewInput_Base
{

public:
	enum { IDD = IDD_DLGWIZPM_RIGHTVIEWINPUT_SOLARPRESADV };

	CDlgWizardPM_RightViewInput_SolarPressureAdvance( CWizardSelPMParams *pclWizardSelPMParams, CWnd *pclParent );

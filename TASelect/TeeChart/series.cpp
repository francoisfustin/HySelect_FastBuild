...
CActivityGauge CSeries::GetAsActivityGauge()
{
	LPDISPATCH pDispatch;
...
CEqualizerSeries CSeries::GetAsEqualizerSeries()
{
	LPDISPATCH pDispatch;
...
BOOL CSeries::GetCalcVisiblePoints()
{
	BOOL result;
...
void CSeries::SetCalcVisiblePoints(BOOL bNewValue)
{
	static BYTE parms[] =
		VTS_BOOL;

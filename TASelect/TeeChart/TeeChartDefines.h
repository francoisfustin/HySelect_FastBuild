...
// EAxisTitlePosition
const unsigned long tpStart = 0;
const unsigned long tpCenter = 1;
const unsigned long tpEnd = 2;
...
// EMapMarksText
const unsigned long mtLabel = 0;
const unsigned long mtCode = 1;
const unsigned long mtBoth = 2;

// EMapRenderMode
const unsigned long rmDefault = 0;
const unsigned long rm2D = 1;
const unsigned long rm3D = 2;
...
const unsigned long smsLabelPercentValue = 13;
const unsigned long smsLabelOrValue = 14;
...
// EPointerSizeUnits
const unsigned long suPixels = 0;
const unsigned long suAxis = 1;
...
const unsigned long psVisual = 13;
const unsigned long psDonut = 14;
const unsigned long psArrow = 15;
...
const unsigned long scErrorPoint = 69;
const unsigned long scErrorPoint3D = 70;
const unsigned long scEquiVolume = 71;
const unsigned long scDoubleHorizBar = 72;
const unsigned long scPolarContour = 73;
...
const unsigned long tcClustering = 45;
const unsigned long tcRepaintMonitor = 46;
const unsigned long tcArrow = 47;
const unsigned long tcScrollPager = 48;
const unsigned long tcAxisScrollBar = 49;

// ETowerStacked
const unsigned long tsNone = 0;
const unsigned long tsStacked = 1;
const unsigned long tsStacked100 = 2;
...
const unsigned long wmEurasia = 14;
const unsigned long wmUK = 15;
const unsigned long wmGermany = 16;
const unsigned long wmUSACounties = 17;
const unsigned long wmUSAAlaskaCounties = 18;
const unsigned long wmJapan = 19;
const unsigned long wmChina = 20;
const unsigned long wmFrance = 21;

...
/* To avoid SonarQube major error with the the '{' in the 'BEGIN_DYNAMIC_MAP' macro I set the corresponding code
   just after.
...
const cdxCDynamicWnd::__dynEntry *cdxCDynamicPropSheet::__getDynMap(const __dynEntry *pLast) const 
{ 
	if(pLast == __M_dynEntry) 
		return 0; 
	
	return (pLast = cdxCDynamicWnd::__getDynMap(pLast)) ? pLast : __M_dynEntry; 
} 

const cdxCDynamicWnd::__dynEntry cdxCDynamicPropSheet::__M_dynEntry[] = 
{
	{ cdxCDynamicWnd::__modes, ID_WIZNEXT, cdxCDynamicWnd::mdRepos,cdxCDynamicWnd::mdRepos },
	{ cdxCDynamicWnd::__modes, ID_WIZFINISH, cdxCDynamicWnd::mdRepos,cdxCDynamicWnd::mdRepos },
	{ cdxCDynamicWnd::__modes, ID_WIZBACK, cdxCDynamicWnd::mdRepos,cdxCDynamicWnd::mdRepos },
	{ cdxCDynamicWnd::__modes, IDOK, cdxCDynamicWnd::mdRepos,cdxCDynamicWnd::mdRepos },
	{ cdxCDynamicWnd::__modes, IDCANCEL, cdxCDynamicWnd::mdRepos,cdxCDynamicWnd::mdRepos },
	{ cdxCDynamicWnd::__modes, ID_WIZNEXT, cdxCDynamicWnd::mdRepos,cdxCDynamicWnd::mdRepos },
	{ cdxCDynamicWnd::__modes, ID_APPLY_NOW, cdxCDynamicWnd::mdRepos,cdxCDynamicWnd::mdRepos },
	{ cdxCDynamicWnd::__modes, IDHELP, cdxCDynamicWnd::mdRepos,cdxCDynamicWnd::mdRepos },
	{ cdxCDynamicWnd::__modes, AFX_IDC_TAB_CONTROL, cdxCDynamicWnd::mdResize,cdxCDynamicWnd::mdResize },
	{ cdxCDynamicWnd::__modes, ID_WIZFINISH+1, cdxCDynamicWnd::mdResize,cdxCDynamicWnd::mdRepos },
	{ cdxCDynamicWnd::__end }
};

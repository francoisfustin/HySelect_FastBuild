...
CDlgWizardPM_RightViewInput_SolarPressureAdvance::CDlgWizardPM_RightViewInput_SolarPressureAdvance( CWizardSelPMParams *pclWizardSelPMParams, CWnd *pclParent )
	: CDlgWizardPM_RightViewInput_Base( pclWizardSelPMParams, SolarPressureAdvance, IDD, pclParent )
{
	m_bGoToNormalModeMsgSent = false;
}

void CDlgWizardPM_RightViewInput_SolarPressureAdvance::ApplyPMInputUserUpdated( bool bWaterCharUpdated, bool bShowErrorMsg )
{
...
int CDlgWizardPM_RightViewInput_SolarPressureAdvance::IsAtLeastOneError( int &iErrorMaskNormal, int &iErrorMaskAdvanced )
{
...
BEGIN_MESSAGE_MAP( CDlgWizardPM_RightViewInput_SolarPressureAdvance, CDlgWizardPM_RightViewInput_Base )
	ON_WM_LBUTTONDOWN()
...
void CDlgWizardPM_RightViewInput_SolarPressureAdvance::DoDataExchange( CDataExchange *pDX )
{
	CDlgWizardPM_RightViewInput_Base::DoDataExchange( pDX );

	DDX_Control( pDX, IDC_STATIC_HST, m_StaticStaticHeight );
	DDX_Control( pDX, IDC_STATIC_P1, m_StaticP0 );
...
BOOL CDlgWizardPM_RightViewInput_SolarPressureAdvance::OnInitDialog()
{
	...
	// Pressurisation on:
	str = TASApp.LoadLocalizedString( IDS_DLGWIZPM_RVIEWINPUTSOLARPRESS_PRESSON );
	m_StaticComboPressOn.SetTextAndToolTip( str );

	// Pump head:
	str = TASApp.LoadLocalizedString( IDS_DLGWIZPM_RVIEWINPUTSOLARPRESS_PUMPHEAD );
...
void CDlgWizardPM_RightViewInput_SolarPressureAdvance::OnPaint()
{
...
void CDlgWizardPM_RightViewInput_SolarPressureAdvance::OnLButtonDown( UINT nFlags, CPoint point )
{
	if( false == m_bGoToNormalModeMsgSent )
	{
		...
		if( TRUE == rectGoButton.PtInRect( (POINT)point ) )
		{
			...
			m_pclParent->PostMessage( WM_USER_RIGHTVIEWWIZPM_SWITCHMODE, WPARAM( SolarPressure ), 0 );
		}
	}
...
void CDlgWizardPM_RightViewInput_SolarPressureAdvance::OnEnSetFocusStaticHeight()
{
	m_ExtEditStaticHeight.SetSel( 0, -1 );
	m_dStaticHeightSaved = m_ExtEditStaticHeight.GetCurrentValSI();
}

void CDlgWizardPM_RightViewInput_SolarPressureAdvance::OnEnSetFocusPz()
{
	m_ExtEditPz.SetSel( 0, -1 );
	m_dPzSaved = m_ExtEditPz.GetCurrentValSI();
}

void CDlgWizardPM_RightViewInput_SolarPressureAdvance::OnEnSetFocusSafetyVRP()
{
	m_ExtEditSafetyVRP.SetSel( 0, -1 );
	m_dSafetyVRPSaved = m_ExtEditSafetyVRP.GetCurrentValSI();
}

void CDlgWizardPM_RightViewInput_SolarPressureAdvance::OnEnSetFocusPumpHead()
{
	m_ExtEditPumpHead.SetSel( 0, -1 );
	m_dPumpHeadSaved = m_ExtEditPumpHead.GetCurrentValSI();
}

void CDlgWizardPM_RightViewInput_SolarPressureAdvance::OnEnChangeStaticHeight()
{
	if( NULL == m_pclWizardSelPMParams || NULL == m_pclWizardSelPMParams->m_pclSelectPMList 
			|| NULL == m_pclWizardSelPMParams->m_pclSelectPMList->GetpclPMInputUser() )
	{
...
void CDlgWizardPM_RightViewInput_SolarPressureAdvance::OnKillFocusStaticHeight()
{
	if( NULL == m_pclWizardSelPMParams || NULL == m_pclWizardSelPMParams->m_pclSelectPMList 
			|| NULL == m_pclWizardSelPMParams->m_pclSelectPMList->GetpclPMInputUser() )
	{
...
void CDlgWizardPM_RightViewInput_SolarPressureAdvance::OnKillFocusPz()
{
	if( NULL == m_pclWizardSelPMParams || NULL == m_pclWizardSelPMParams->m_pclSelectPMList 
			|| NULL == m_pclWizardSelPMParams->m_pclSelectPMList->GetpclPMInputUser() )
	{
...
void CDlgWizardPM_RightViewInput_SolarPressureAdvance::OnKillFocusSafetyVRP()
{
	if( NULL == m_pclWizardSelPMParams || NULL == m_pclWizardSelPMParams->m_pclSelectPMList 
			|| NULL == m_pclWizardSelPMParams->m_pclSelectPMList->GetpclPMInputUser() )
	{
...
void CDlgWizardPM_RightViewInput_SolarPressureAdvance::OnKillFocusPumpHead()
{
	if( NULL == m_pclWizardSelPMParams || NULL == m_pclWizardSelPMParams->m_pclSelectPMList 
			|| NULL == m_pclWizardSelPMParams->m_pclSelectPMList->GetpclPMInputUser() )
	{
...
void CDlgWizardPM_RightViewInput_SolarPressureAdvance::OnBnClickedCheckPz()
{
...
void CDlgWizardPM_RightViewInput_SolarPressureAdvance::OnCbnSelChangePressOn()
{
	if( NULL == m_pclWizardSelPMParams || NULL == m_pclWizardSelPMParams->m_pclSelectPMList 
			|| NULL == m_pclWizardSelPMParams->m_pclSelectPMList->GetpclPMInputUser() )
	{
...
void CDlgWizardPM_RightViewInput_SolarPressureAdvance::UpdateP0()
{
	if( NULL == m_pclWizardSelPMParams || NULL == m_pclWizardSelPMParams->m_pclSelectPMList ||
			NULL == m_pclWizardSelPMParams->m_pclSelectPMList->GetpclPMInputUser() )
	{
...
LRESULT CDlgWizardPM_RightViewInput_SolarPressureAdvance::OnUnitChange( WPARAM wParam, LPARAM lParam )
{
...
void CDlgWizardPM_RightViewInput_SolarPressureAdvance::GetExtEditList( CArray<CExtNumEdit*> &arExtEditList )
{
	arExtEditList.Add( &m_ExtEditPz );
	arExtEditList.Add( &m_ExtEditSafetyVRP );
}

void CDlgWizardPM_RightViewInput_SolarPressureAdvance::_VerifyInputValues()
{
	CheckPz( &m_BtnCheckPz, &m_ExtEditPz );
	CheckSafetyVRP( &m_ExtEditSafetyVRP, &m_StaticSafetyVRPMinimum );

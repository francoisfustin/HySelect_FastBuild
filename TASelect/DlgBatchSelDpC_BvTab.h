...
class CDlgBatchSelDpC_BvTab : public CDialogExt
{
public:
	enum { IDD = IDD_DLGBATCHSELDPC_BVTAB };
	CDlgBatchSelDpC_BvTab( CBatchSelDpCParams &clBatchSelDpCParams, CWnd *pParent = NULL );
	virtual ~CDlgBatchSelDpC_BvTab() {}

	void SaveSelectionParameters( void );

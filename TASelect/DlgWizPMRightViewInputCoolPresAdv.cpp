...
CDlgWizardPM_RightViewInput_CoolingPressureAdvance::CDlgWizardPM_RightViewInput_CoolingPressureAdvance( CWizardSelPMParams *pclWizardSelPMParams, CWnd *pclParent )
	: CDlgWizardPM_RightViewInput_Base( pclWizardSelPMParams, CoolingPressureAdvance, IDD, pclParent )
{
	m_bGoToNormalModeMsgSent = false;
}

void CDlgWizardPM_RightViewInput_CoolingPressureAdvance::ApplyPMInputUserUpdated( bool bWaterCharUpdated, bool bShowErrorMsg )
{
...
int CDlgWizardPM_RightViewInput_CoolingPressureAdvance::IsAtLeastOneError( int &iErrorMaskNormal, int &iErrorMaskAdvanced )
{
...
BEGIN_MESSAGE_MAP( CDlgWizardPM_RightViewInput_CoolingPressureAdvance, CDlgWizardPM_RightViewInput_Base )
	ON_WM_LBUTTONDOWN()
...
void CDlgWizardPM_RightViewInput_CoolingPressureAdvance::DoDataExchange( CDataExchange *pDX )
{
	...
	DDX_Control( pDX, IDC_STATIC_PSVMINIMUM2, m_StaticSafetyVRPMinimum );
...
BOOL CDlgWizardPM_RightViewInput_CoolingPressureAdvance::OnInitDialog()
{
	CDlgWizardPM_RightViewInput_Base::OnInitDialog();

	SetMainTitle( TASApp.LoadLocalizedString( IDS_DLGWIZPM_RVIEWCOOLPRES_MAINTITLE ) );
	...
	// Static height[Hst]:
	str = TASApp.LoadLocalizedString( IDS_DLGWIZPM_RVIEWINPUTCOOLPRESS_HST );
	...
	str = TASApp.LoadLocalizedString( IDS_DLGWIZPM_RVIEWINPUTCOOLPRESS_SVRP );
	...
	// Pressurisation on:
	str = TASApp.LoadLocalizedString( IDS_DLGWIZPM_RVIEWINPUTCOOLPRESS_PRESSON );
	m_StaticComboPressOn.SetTextAndToolTip( str );

	// Pump head:
	str = TASApp.LoadLocalizedString( IDS_DLGWIZPM_RVIEWINPUTCOOLPRESS_PUMPHEAD );
...
void CDlgWizardPM_RightViewInput_CoolingPressureAdvance::OnPaint()
{
...
void CDlgWizardPM_RightViewInput_CoolingPressureAdvance::OnLButtonDown( UINT nFlags, CPoint point )
{
	if( false == m_bGoToNormalModeMsgSent )
	{
		...
		if( TRUE == rectGoButton.PtInRect( (POINT)point ) )
		{
			...
			m_pclParent->PostMessage( WM_USER_RIGHTVIEWWIZPM_SWITCHMODE, WPARAM( CoolingPressure ), 0 );
		}
	}
...
void CDlgWizardPM_RightViewInput_CoolingPressureAdvance::OnEnSetFocusStaticHeight()
{
	m_ExtEditStaticHeight.SetSel( 0, -1 );
	m_dStaticHeightSaved = m_ExtEditStaticHeight.GetCurrentValSI();
}

void CDlgWizardPM_RightViewInput_CoolingPressureAdvance::OnEnSetFocusPz()
{
	m_ExtEditPz.SetSel( 0, -1 );
	m_dPzSaved = m_ExtEditPz.GetCurrentValSI();
}

void CDlgWizardPM_RightViewInput_CoolingPressureAdvance::OnEnSetFocusSafetyVRP()
{
	m_ExtEditSafetyVRP.SetSel( 0, -1 );
	m_dSafetyVRPSaved = m_ExtEditSafetyVRP.GetCurrentValSI();
}

void CDlgWizardPM_RightViewInput_CoolingPressureAdvance::OnEnSetFocusPumpHead()
{
	m_ExtEditPumpHead.SetSel( 0, -1 );
	m_dPumpHeadSaved = m_ExtEditPumpHead.GetCurrentValSI();
}

void CDlgWizardPM_RightViewInput_CoolingPressureAdvance::OnEnChangeStaticHeight()
{
	if( NULL == m_pclWizardSelPMParams || NULL == m_pclWizardSelPMParams->m_pclSelectPMList 
			|| NULL == m_pclWizardSelPMParams->m_pclSelectPMList->GetpclPMInputUser() )
	{
...
void CDlgWizardPM_RightViewInput_CoolingPressureAdvance::OnKillFocusStaticHeight()
{
	if( NULL == m_pclWizardSelPMParams || NULL == m_pclWizardSelPMParams->m_pclSelectPMList 
			|| NULL == m_pclWizardSelPMParams->m_pclSelectPMList->GetpclPMInputUser() )
	{
...
void CDlgWizardPM_RightViewInput_CoolingPressureAdvance::OnKillFocusPz()
{
	if( NULL == m_pclWizardSelPMParams || NULL == m_pclWizardSelPMParams->m_pclSelectPMList 
			|| NULL == m_pclWizardSelPMParams->m_pclSelectPMList->GetpclPMInputUser() )
	{
...
void CDlgWizardPM_RightViewInput_CoolingPressureAdvance::OnKillFocusSafetyVRP()
{
	if( NULL == m_pclWizardSelPMParams || NULL == m_pclWizardSelPMParams->m_pclSelectPMList 
			|| NULL == m_pclWizardSelPMParams->m_pclSelectPMList->GetpclPMInputUser() )
	{
...
void CDlgWizardPM_RightViewInput_CoolingPressureAdvance::OnKillFocusPumpHead()
{
	if( NULL == m_pclWizardSelPMParams || NULL == m_pclWizardSelPMParams->m_pclSelectPMList 
			|| NULL == m_pclWizardSelPMParams->m_pclSelectPMList->GetpclPMInputUser() )
	{
...
void CDlgWizardPM_RightViewInput_CoolingPressureAdvance::OnBnClickedCheckPz()
{
...
void CDlgWizardPM_RightViewInput_CoolingPressureAdvance::OnCbnSelChangePressOn()
{
	if( NULL == m_pclWizardSelPMParams || NULL == m_pclWizardSelPMParams->m_pclSelectPMList 
			|| NULL == m_pclWizardSelPMParams->m_pclSelectPMList->GetpclPMInputUser() )
	{
...
void CDlgWizardPM_RightViewInput_CoolingPressureAdvance::UpdateP0()
{
	if( NULL == m_pclWizardSelPMParams || NULL == m_pclWizardSelPMParams->m_pclSelectPMList ||
			NULL == m_pclWizardSelPMParams->m_pclSelectPMList->GetpclPMInputUser() )
	{
...
LRESULT CDlgWizardPM_RightViewInput_CoolingPressureAdvance::OnUnitChange( WPARAM wParam, LPARAM lParam )
{
...
void CDlgWizardPM_RightViewInput_CoolingPressureAdvance::GetExtEditList( CArray<CExtNumEdit*> &arExtEditList )
{
	arExtEditList.Add( &m_ExtEditPz );
	arExtEditList.Add( &m_ExtEditSafetyVRP );
}

void CDlgWizardPM_RightViewInput_CoolingPressureAdvance::_VerifyInputValues()
{
	CheckPz( &m_BtnCheckPz, &m_ExtEditPz );
	CheckSafetyVRP( &m_ExtEditSafetyVRP, &m_StaticSafetyVRPMinimum );

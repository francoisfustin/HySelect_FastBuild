...
CDlgWizardPM_RightViewInput_HeatingPressure::CDlgWizardPM_RightViewInput_HeatingPressure( CWizardSelPMParams *pclWizardSelPMParams, CWnd *pclParent )
	: CDlgWizardPM_RightViewInput_Base( pclWizardSelPMParams, HeatingPressure, IDD, pclParent )
{
	m_bGoToAdvModeMsgSent = false;
}

void CDlgWizardPM_RightViewInput_HeatingPressure::ApplyPMInputUserUpdated( bool bWaterCharUpdated, bool bShowErrorMsg )
{
	...
	if( BST_CHECKED == m_BtnCheckPz.GetCheck() 
			&& m_ExtEditPz.GetCurrentValSI() != pclPMInputUser->GetPz() )
	{
		m_dPzSaved = pclPMInputUser->GetPz();
		m_ExtEditPz.SetCurrentValSI( m_dPzSaved );
		m_ExtEditPz.Update();
		bAtLeastOneChange = true;
	}
...
int CDlgWizardPM_RightViewInput_HeatingPressure::IsAtLeastOneError( int &iErrorMaskNormal, int &iErrorMaskAdvanced )
{
...
BEGIN_MESSAGE_MAP( CDlgWizardPM_RightViewInput_HeatingPressure, CDlgWizardPM_RightViewInput_Base )
	ON_WM_LBUTTONDOWN()
...
void CDlgWizardPM_RightViewInput_HeatingPressure::DoDataExchange( CDataExchange *pDX )
{
	...
	DDX_Control( pDX, IDC_STATIC_STATICPSVLOCATIONUNIT, m_StaticSVLocationUnit );						// HYS-1083.
...
BOOL CDlgWizardPM_RightViewInput_HeatingPressure::OnInitDialog()
{
	...
	str = TASApp.LoadLocalizedString( IDS_DLGWIZPM_RVIEWINPUTHEATPRESS_PSVLOCATION );
...
void CDlgWizardPM_RightViewInput_HeatingPressure::OnPaint()
{
...
void CDlgWizardPM_RightViewInput_HeatingPressure::OnLButtonDown( UINT nFlags, CPoint point )
{
	if( false == m_bGoToAdvModeMsgSent )
	{
		...
		if( TRUE == rectGoButton.PtInRect( (POINT)point ) )
		{
			...
			m_pclParent->PostMessage( WM_USER_RIGHTVIEWWIZPM_SWITCHMODE, WPARAM( HeatingPressureAdvance ), 0 );
		}
	}
...
void CDlgWizardPM_RightViewInput_HeatingPressure::OnEnSetFocusStaticHeight()
{
	m_ExtEditStaticHeight.SetSel( 0, -1 );
	m_dStaticHeightSaved = m_ExtEditStaticHeight.GetCurrentValSI();
}

void CDlgWizardPM_RightViewInput_HeatingPressure::OnEnSetFocusPz()
{
	m_ExtEditPz.SetSel( 0, -1 );
	m_dPzSaved = m_ExtEditPz.GetCurrentValSI();
}

void CDlgWizardPM_RightViewInput_HeatingPressure::OnEnSetFocusSafetyVRP()
{
	m_ExtEditSafetyVRP.SetSel( 0, -1 );
	m_dSafetyVRPSaved = m_ExtEditSafetyVRP.GetCurrentValSI();
}

void CDlgWizardPM_RightViewInput_HeatingPressure::OnEnChangeStaticHeight()
{
	if( NULL == m_pclWizardSelPMParams || NULL == m_pclWizardSelPMParams->m_pclSelectPMList 
			|| NULL == m_pclWizardSelPMParams->m_pclSelectPMList->GetpclPMInputUser() )
	{
...
// HYS-1083.
void CDlgWizardPM_RightViewInput_HeatingPressure::OnEnSetFocuspSVLocation()
{
	m_EditpSVLocation.SetSel( 0, -1 );
	m_dpSVLocationSaved = m_EditpSVLocation.GetCurrentValSI();
}

void CDlgWizardPM_RightViewInput_HeatingPressure::OnKillFocusStaticHeight()
{
	if( NULL == m_pclWizardSelPMParams || NULL == m_pclWizardSelPMParams->m_pclSelectPMList 
			|| NULL == m_pclWizardSelPMParams->m_pclSelectPMList->GetpclPMInputUser() )
	{
...
void CDlgWizardPM_RightViewInput_HeatingPressure::OnKillFocusPz()
{
	if( NULL == m_pclWizardSelPMParams || NULL == m_pclWizardSelPMParams->m_pclSelectPMList 
			|| NULL == m_pclWizardSelPMParams->m_pclSelectPMList->GetpclPMInputUser() )
	{
...
void CDlgWizardPM_RightViewInput_HeatingPressure::OnKillFocusSafetyVRP()
{
	if( NULL == m_pclWizardSelPMParams || NULL == m_pclWizardSelPMParams->m_pclSelectPMList 
			|| NULL == m_pclWizardSelPMParams->m_pclSelectPMList->GetpclPMInputUser() )
	{
...
// HYS-1083.
void CDlgWizardPM_RightViewInput_HeatingPressure::OnKillFocuspSVLocation()
{
	if( NULL == m_pclWizardSelPMParams || NULL == m_pclWizardSelPMParams->m_pclSelectPMList
		|| NULL == m_pclWizardSelPMParams->m_pclSelectPMList->GetpclPMInputUser() )
	{
...
void CDlgWizardPM_RightViewInput_HeatingPressure::OnBnClickedCheckPz()
{
	...
	// Do not save pz if error.
	if( Error_Pressure_Pz != ( Error_Pressure_Pz & iErrorCode ) )
	{
		m_pclWizardSelPMParams->m_pclSelectPMList->GetpclPMInputUser()->SetPz( m_ExtEditPz.GetCurrentValSI() );
	}
...
void CDlgWizardPM_RightViewInput_HeatingPressure::UpdateP0()
{
	if( NULL == m_pclWizardSelPMParams || NULL == m_pclWizardSelPMParams->m_pclSelectPMList ||
			NULL == m_pclWizardSelPMParams->m_pclSelectPMList->GetpclPMInputUser() )
	{
...
void CDlgWizardPM_RightViewInput_HeatingPressure::OnBnClickedCheckpSVLocation()
{
	if( NULL == m_pclWizardSelPMParams || NULL == m_pclWizardSelPMParams->m_pclSelectPMList
		|| NULL == m_pclWizardSelPMParams->m_pclSelectPMList->GetpclPMInputUser() )
	{
...
LRESULT CDlgWizardPM_RightViewInput_HeatingPressure::OnUnitChange( WPARAM wParam, LPARAM lParam )
{
...
void CDlgWizardPM_RightViewInput_HeatingPressure::GetExtEditList( CArray<CExtNumEdit*> &arExtEditList )
{
...
void CDlgWizardPM_RightViewInput_HeatingPressure::_VerifyInputValues()
{
	CheckPz( &m_BtnCheckPz, &m_ExtEditPz );
	CheckSafetyVRP( &m_ExtEditSafetyVRP, &m_StaticSafetyVRPMinimum );
	// Check the safety valve location.

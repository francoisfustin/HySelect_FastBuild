...
class CDlgWizardPM_RightViewInput_CoolingRequirement2 : public CDlgWizardPM_RightViewInput_Base
{

public:
	enum { IDD = IDD_DLGWIZPM_RIGHTVIEWINPUT_COOLREQU2 };

	CDlgWizardPM_RightViewInput_CoolingRequirement2( CWizardSelPMParams *pclWizardSelPMParams, CWnd *pclParent );

...
class CDlgWizardPM_RightViewInput_SolarPressure : public CDlgWizardPM_RightViewInput_Base
{

public:
	enum { IDD = IDD_DLGWIZPM_RIGHTVIEWINPUT_SOLARPRES };

	CDlgWizardPM_RightViewInput_SolarPressure( CWizardSelPMParams *pclWizardSelPMParams, CWnd *pclParent );

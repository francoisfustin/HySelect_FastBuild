...
CDlgWizardPM_RightViewInput_CoolingRequirement::CDlgWizardPM_RightViewInput_CoolingRequirement( CWizardSelPMParams *pclWizardSelPMParams, CWnd *pclParent )
	: CDlgWizardPM_RightViewInput_Base( pclWizardSelPMParams, CoolingRequirement, IDD, pclParent )
{
...
void CDlgWizardPM_RightViewInput_CoolingRequirement::ApplyPMInputUserUpdated( bool bWaterCharUpdated, bool bShowErrorMsg )
{
...
BEGIN_MESSAGE_MAP( CDlgWizardPM_RightViewInput_CoolingRequirement, CDlgWizardPM_RightViewInput_Base )
...
void CDlgWizardPM_RightViewInput_CoolingRequirement::DoDataExchange( CDataExchange *pDX )
{
...
BOOL CDlgWizardPM_RightViewInput_CoolingRequirement::OnInitDialog()
{
	CDlgWizardPM_RightViewInput_Base::OnInitDialog();

	SetMainTitle( TASApp.LoadLocalizedString( IDS_DLGWIZPM_RVIEWCOOLREQU_MAINTITLE ) );
...
void CDlgWizardPM_RightViewInput_CoolingRequirement::OnSize( UINT nType, int cx, int cy )
{
...
void CDlgWizardPM_RightViewInput_CoolingRequirement::OnBnClickedGeneralCombi()
{
...
void CDlgWizardPM_RightViewInput_CoolingRequirement::OnBnClickedGeneralRedundancyPump()
{
	if( NULL == m_pclWizardSelPMParams || NULL == m_pclWizardSelPMParams->m_pclSelectPMList || NULL == m_pclWizardSelPMParams->m_pclSelectPMList->GetpclPMInputUser() 
			|| NULL == m_pclWizardSelPMParams->m_pclSelectPMList->GetpclPMInputUser()->GetPMWQSelectionPreferences()  )
	{
...
void CDlgWizardPM_RightViewInput_CoolingRequirement::OnBnClickedGeneralRedundancyTecBox()
{
	if( NULL == m_pclWizardSelPMParams || NULL == m_pclWizardSelPMParams->m_pclSelectPMList || NULL == m_pclWizardSelPMParams->m_pclSelectPMList->GetpclPMInputUser() 
			|| NULL == m_pclWizardSelPMParams->m_pclSelectPMList->GetpclPMInputUser()->GetPMWQSelectionPreferences()  )
	{
...
void CDlgWizardPM_RightViewInput_CoolingRequirement::OnBnClickedCompBasedCoating()
{
	if( NULL == m_pclWizardSelPMParams || NULL == m_pclWizardSelPMParams->m_pclSelectPMList || NULL == m_pclWizardSelPMParams->m_pclSelectPMList->GetpclPMInputUser() 
			|| NULL == m_pclWizardSelPMParams->m_pclSelectPMList->GetpclPMInputUser()->GetPMWQSelectionPreferences()  )
	{
...
void CDlgWizardPM_RightViewInput_CoolingRequirement::OnBnClickedCompBasedCompressedAir()
{
	if( NULL == m_pclWizardSelPMParams || NULL == m_pclWizardSelPMParams->m_pclSelectPMList || NULL == m_pclWizardSelPMParams->m_pclSelectPMList->GetpclPMInputUser() 
			|| NULL == m_pclWizardSelPMParams->m_pclSelectPMList->GetpclPMInputUser()->GetPMWQSelectionPreferences()  )
	{
...
void CDlgWizardPM_RightViewInput_CoolingRequirement::OnBnClickedPumpDegasingBasedCoolingInsulation()
{
	if( NULL == m_pclWizardSelPMParams || NULL == m_pclWizardSelPMParams->m_pclSelectPMList || NULL == m_pclWizardSelPMParams->m_pclSelectPMList->GetpclPMInputUser() 
			|| NULL == m_pclWizardSelPMParams->m_pclSelectPMList->GetpclPMInputUser()->GetPMWQSelectionPreferences()  )
	{
...
void CDlgWizardPM_RightViewInput_CoolingRequirement::_VerifyInputValues()
{

...
CDlgWizardPM_RightViewInput_CoolingPMType::CDlgWizardPM_RightViewInput_CoolingPMType( CWizardSelPMParams *pclWizardSelPMParams, CWnd *pclParent )
	: CDlgWizardPM_RightViewInput_Base( pclWizardSelPMParams, CoolingPressurisationMaintenanceType, IDD, pclParent )
{
}

void CDlgWizardPM_RightViewInput_CoolingPMType::ApplyPMInputUserUpdated( bool bWaterCharUpdated, bool bShowErrorMsg )
{
...
int CDlgWizardPM_RightViewInput_CoolingPMType::IsAtLeastOneError( int &iErrorMaskNormal, int &iErrorMaskAdvanced )
{
	if( NULL == m_pclWizardSelPMParams || NULL == m_pclWizardSelPMParams->m_pclSelectPMList 
			|| NULL == m_pclWizardSelPMParams->m_pclSelectPMList->GetpclPMInputUser() )
	{
...
BEGIN_MESSAGE_MAP( CDlgWizardPM_RightViewInput_CoolingPMType, CDlgWizardPM_RightViewInput_Base )
...
void CDlgWizardPM_RightViewInput_CoolingPMType::DoDataExchange( CDataExchange *pDX )
{
...
BOOL CDlgWizardPM_RightViewInput_CoolingPMType::OnInitDialog()
{
	CDlgWizardPM_RightViewInput_Base::OnInitDialog();

	SetMainTitle( TASApp.LoadLocalizedString( IDS_DLGWIZPM_RVIEWCOOLPMTYPE_MAINTITLE ) );
...
void CDlgWizardPM_RightViewInput_CoolingPMType::OnCbnSelChangePressureMaintenanceType()
{
	if( NULL == m_pclWizardSelPMParams || NULL == m_pclWizardSelPMParams->m_pclSelectPMList 
			|| NULL == m_pclWizardSelPMParams->m_pclSelectPMList->GetpclPMInputUser() )
	{
...
void CDlgWizardPM_RightViewInput_CoolingPMType::OnCbnSelChangeWaterMakeUpType()
{
	if( NULL == m_pclWizardSelPMParams || NULL == m_pclWizardSelPMParams->m_pclSelectPMList 
			|| NULL == m_pclWizardSelPMParams->m_pclSelectPMList->GetpclPMInputUser() )
	{
...
void CDlgWizardPM_RightViewInput_CoolingPMType::OnEnSetFocusWaterMakeUpNetworkPN()
{
	m_ExtEditWaterMakeUpNetworkPN.SetSel( 0, -1 );
}

void CDlgWizardPM_RightViewInput_CoolingPMType::OnEnSetFocusWaterHardness()
{
	m_ExtEditWaterHardness.SetSel( 0, -1 );
}

void CDlgWizardPM_RightViewInput_CoolingPMType::OnKillFocusWaterMakeUpNetworkPN()
{
	if( NULL == m_pclWizardSelPMParams || NULL == m_pclWizardSelPMParams->m_pclSelectPMList 
			|| NULL == m_pclWizardSelPMParams->m_pclSelectPMList->GetpclPMInputUser() )
	{
...
void CDlgWizardPM_RightViewInput_CoolingPMType::OnKillFocusEditWaterHardness()
{
	if( NULL == m_pclWizardSelPMParams || NULL == m_pclWizardSelPMParams->m_pclSelectPMList 
			|| NULL == m_pclWizardSelPMParams->m_pclSelectPMList->GetpclPMInputUser() )
	{
	...
	m_ExtEditWaterHardness.IsDrawBorderActivated();
...
void CDlgWizardPM_RightViewInput_CoolingPMType::OnBnClickedDegassing()
{
	if( NULL == m_pclWizardSelPMParams || NULL == m_pclWizardSelPMParams->m_pclSelectPMList 
			|| NULL == m_pclWizardSelPMParams->m_pclSelectPMList->GetpclPMInputUser() )
	{
...
LRESULT CDlgWizardPM_RightViewInput_CoolingPMType::OnUnitChange( WPARAM wParam, LPARAM lParam )
{
...
void CDlgWizardPM_RightViewInput_CoolingPMType::GetExtEditList( CArray<CExtNumEdit*> &arExtEditList )
{
	arExtEditList.Add( &m_ExtEditWaterMakeUpNetworkPN );
}

void CDlgWizardPM_RightViewInput_CoolingPMType::_VerifyInputValues()
{
	if( NULL == m_pclWizardSelPMParams || NULL == m_pclWizardSelPMParams->m_pclSelectPMList 
			|| NULL == m_pclWizardSelPMParams->m_pclSelectPMList->GetpclPMInputUser() )
	{

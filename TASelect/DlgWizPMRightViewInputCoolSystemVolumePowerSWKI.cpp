...
CDlgWizardPM_RightViewInput_CoolingSystemVolumePowerSWKI::CDlgWizardPM_RightViewInput_CoolingSystemVolumePowerSWKI( CWizardSelPMParams *pclWizardSelPMParams, CWnd *pclParent )
	: CDlgWizardPM_RightViewInput_Base( pclWizardSelPMParams, CoolingSystemVolumePower, IDD, pclParent )
{
	m_bGoToAdvModeMsgSent = false;
}

void CDlgWizardPM_RightViewInput_CoolingSystemVolumePowerSWKI::ApplyPMInputUserUpdated( bool bWaterCharUpdated, bool bShowErrorMsg )
{
...
int CDlgWizardPM_RightViewInput_CoolingSystemVolumePowerSWKI::IsAtLeastOneError( int &iErrorMaskNormal, int &iErrorMaskAdvanced )
{
	if( NULL == m_pclWizardSelPMParams || NULL == m_pclWizardSelPMParams->m_pclSelectPMList 
			|| NULL == m_pclWizardSelPMParams->m_pclSelectPMList->GetpclPMInputUser() )
	{
...
BEGIN_MESSAGE_MAP( CDlgWizardPM_RightViewInput_CoolingSystemVolumePowerSWKI, CDlgWizardPM_RightViewInput_Base )
	ON_WM_LBUTTONDOWN()
...
void CDlgWizardPM_RightViewInput_CoolingSystemVolumePowerSWKI::DoDataExchange( CDataExchange *pDX )
{
...
BOOL CDlgWizardPM_RightViewInput_CoolingSystemVolumePowerSWKI::OnInitDialog()
{
	if( NULL == m_pclWizardSelPMParams || NULL == m_pclWizardSelPMParams->m_pclSelectPMList 
			|| NULL == m_pclWizardSelPMParams->m_pclSelectPMList->GetpclPMInputUser() )
	{
...
void CDlgWizardPM_RightViewInput_CoolingSystemVolumePowerSWKI::OnPaint()
{
...
void CDlgWizardPM_RightViewInput_CoolingSystemVolumePowerSWKI::OnLButtonDown( UINT nFlags, CPoint point )
{
	if( NULL == m_pclWizardSelPMParams || NULL == m_pclWizardSelPMParams->m_pclSelectPMList 
			|| NULL == m_pclWizardSelPMParams->m_pclSelectPMList->GetpclPMInputUser() )
	{
...
void CDlgWizardPM_RightViewInput_CoolingSystemVolumePowerSWKI::OnEnSetFocusSystemVolume()
{
	m_ExtEditSystemVolume.SetSel( 0, -1 );
	m_dSystemVolumeSaved = m_ExtEditSystemVolume.GetCurrentValSI();
}

void CDlgWizardPM_RightViewInput_CoolingSystemVolumePowerSWKI::OnEnSetFocusStorageTankVolume()
{
	m_ExtEditStorageTankVolume.SetSel( 0, -1 );
	m_dStorageTankVolumeSaved = m_ExtEditStorageTankVolume.GetCurrentValSI();
}

void CDlgWizardPM_RightViewInput_CoolingSystemVolumePowerSWKI::OnEnSetFocusStorageTankMaxTemp()
{
	m_ExtEditStorageTankMaxTemp.SetSel( 0, -1 );
	m_dStorageTankMaxTempSaved = m_ExtEditStorageTankMaxTemp.GetCurrentValSI();
}

void CDlgWizardPM_RightViewInput_CoolingSystemVolumePowerSWKI::OnEnSetFocusInstalledPower()
{
	m_ExtEditInstalledPower.SetSel( 0, -1 );
	m_dInstalledPowerSaved = m_ExtEditSystemVolume.GetCurrentValSI();
}

void CDlgWizardPM_RightViewInput_CoolingSystemVolumePowerSWKI::OnKillFocusSystemVolume()
{
	if( NULL == m_pclWizardSelPMParams || NULL == m_pclWizardSelPMParams->m_pclSelectPMList
			|| NULL == m_pclWizardSelPMParams->m_pclSelectPMList->GetpclPMInputUser() )
	{
...
void CDlgWizardPM_RightViewInput_CoolingSystemVolumePowerSWKI::OnKillFocusStorageTankVolume()
{
	if( NULL == m_pclWizardSelPMParams || NULL == m_pclWizardSelPMParams->m_pclSelectPMList
			|| NULL == m_pclWizardSelPMParams->m_pclSelectPMList->GetpclPMInputUser() )
	{
...
void CDlgWizardPM_RightViewInput_CoolingSystemVolumePowerSWKI::OnKillFocusStorageTankMaxTemp()
{
	if( NULL == m_pclWizardSelPMParams || NULL == m_pclWizardSelPMParams->m_pclSelectPMList
			|| NULL == m_pclWizardSelPMParams->m_pclSelectPMList->GetpclPMInputUser() )
	{
...
void CDlgWizardPM_RightViewInput_CoolingSystemVolumePowerSWKI::OnKillFocusInstalledPower()
{
	if( NULL == m_pclWizardSelPMParams || NULL == m_pclWizardSelPMParams->m_pclSelectPMList
			|| NULL == m_pclWizardSelPMParams->m_pclSelectPMList->GetpclPMInputUser() )
	{
...
LRESULT CDlgWizardPM_RightViewInput_CoolingSystemVolumePowerSWKI::OnUnitChange( WPARAM wParam, LPARAM lParam )
{
...
void CDlgWizardPM_RightViewInput_CoolingSystemVolumePowerSWKI::GetExtEditList( CArray<CExtNumEdit*> &arExtEditList )
{
...
void CDlgWizardPM_RightViewInput_CoolingSystemVolumePowerSWKI::_VerifyInputValues()
{

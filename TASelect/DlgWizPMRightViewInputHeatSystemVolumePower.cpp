...
CDlgWizardPM_RightViewInput_HeatingSystemVolumePower::CDlgWizardPM_RightViewInput_HeatingSystemVolumePower( CWizardSelPMParams *pclWizardSelPMParams, CWnd *pclParent )
	: CDlgWizardPM_RightViewInput_Base( pclWizardSelPMParams, HeatingSystemVolumePower, IDD, pclParent )
{
	m_bGoToAdvModeMsgSent = false;
}

void CDlgWizardPM_RightViewInput_HeatingSystemVolumePower::ApplyPMInputUserUpdated( bool bWaterCharUpdated, bool bShowErrorMsg )
{
...
int CDlgWizardPM_RightViewInput_HeatingSystemVolumePower::IsAtLeastOneError( int &iErrorMaskNormal, int &iErrorMaskAdvanced )
{
	if( NULL == m_pclWizardSelPMParams || NULL == m_pclWizardSelPMParams->m_pclSelectPMList 
			|| NULL == m_pclWizardSelPMParams->m_pclSelectPMList->GetpclPMInputUser() )
	{
...
BEGIN_MESSAGE_MAP( CDlgWizardPM_RightViewInput_HeatingSystemVolumePower, CDlgWizardPM_RightViewInput_Base )
	ON_WM_LBUTTONDOWN()
...
void CDlgWizardPM_RightViewInput_HeatingSystemVolumePower::DoDataExchange( CDataExchange *pDX )
{
...
BOOL CDlgWizardPM_RightViewInput_HeatingSystemVolumePower::OnInitDialog()
{
	if( NULL == m_pclWizardSelPMParams || NULL == m_pclWizardSelPMParams->m_pclSelectPMList 
			|| NULL == m_pclWizardSelPMParams->m_pclSelectPMList->GetpclPMInputUser() )
	{
...
void CDlgWizardPM_RightViewInput_HeatingSystemVolumePower::OnPaint()
{
...
void CDlgWizardPM_RightViewInput_HeatingSystemVolumePower::OnLButtonDown( UINT nFlags, CPoint point )
{
	if( NULL == m_pclWizardSelPMParams || NULL == m_pclWizardSelPMParams->m_pclSelectPMList 
			|| NULL == m_pclWizardSelPMParams->m_pclSelectPMList->GetpclPMInputUser() )
	{
	...
	{
		CRect rectSystemVolume;
		m_ExtEditSystemVolume.GetWindowRect( &rectSystemVolume );
		ScreenToClient( &rectSystemVolume );

		CRect rectInstalledPower;
		m_ExtEditInstalledPower.GetWindowRect( &rectInstalledPower );
		ScreenToClient( &rectInstalledPower );

		if( TRUE == rectSystemVolume.PtInRect( (POINT)point ) || 
...
void CDlgWizardPM_RightViewInput_HeatingSystemVolumePower::OnEnSetFocusSystemVolume()
{
	m_ExtEditSystemVolume.SetSel( 0, -1 );
	m_dSystemVolumeSaved = m_ExtEditSystemVolume.GetCurrentValSI();
}

void CDlgWizardPM_RightViewInput_HeatingSystemVolumePower::OnEnSetFocusInstalledPower()
{
	m_ExtEditInstalledPower.SetSel( 0, -1 );
	m_dInstalledPowerSaved = m_ExtEditSystemVolume.GetCurrentValSI();
}

void CDlgWizardPM_RightViewInput_HeatingSystemVolumePower::OnKillFocusSystemVolume()
{
	if( NULL == m_pclWizardSelPMParams || NULL == m_pclWizardSelPMParams->m_pclSelectPMList
			|| NULL == m_pclWizardSelPMParams->m_pclSelectPMList->GetpclPMInputUser() )
	{
...
void CDlgWizardPM_RightViewInput_HeatingSystemVolumePower::OnKillFocusInstalledPower()
{
	if( NULL == m_pclWizardSelPMParams || NULL == m_pclWizardSelPMParams->m_pclSelectPMList
			|| NULL == m_pclWizardSelPMParams->m_pclSelectPMList->GetpclPMInputUser() )
	{
...
LRESULT CDlgWizardPM_RightViewInput_HeatingSystemVolumePower::OnUnitChange( WPARAM wParam, LPARAM lParam )
{
...
void CDlgWizardPM_RightViewInput_HeatingSystemVolumePower::GetExtEditList( CArray<CExtNumEdit*> &arExtEditList )
{
	arExtEditList.Add( &m_ExtEditSystemVolume );
	arExtEditList.Add( &m_ExtEditInstalledPower );
}

void CDlgWizardPM_RightViewInput_HeatingSystemVolumePower::_VerifyInputValues()
{

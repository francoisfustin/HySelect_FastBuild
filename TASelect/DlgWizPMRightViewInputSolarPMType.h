...
class CDlgWizardPM_RightViewInput_SolarPMType : public CDlgWizardPM_RightViewInput_Base
{

public:
	enum { IDD = IDD_DLGWIZPM_RIGHTVIEWINPUT_SOLARPMTYPE };

	CDlgWizardPM_RightViewInput_SolarPMType( CWizardSelPMParams *pclWizardSelPMParams, CWnd *pclParent );

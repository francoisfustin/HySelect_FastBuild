...
class CDlgWizardPM_RightViewInput_HeatingSystemVolumePowerSWKI : public CDlgWizardPM_RightViewInput_Base
{

public:
	enum { IDD = IDD_DLGWIZPM_RIGHTVIEWINPUT_HEATSYSTEMVOLUMEPOWERSWKI };

	CDlgWizardPM_RightViewInput_HeatingSystemVolumePowerSWKI( CWizardSelPMParams *pclWizardSelPMParams, CWnd *pclParent );

...
class CDlgWizardPM_RightViewInput_SolarTemperature : public CDlgWizardPM_RightViewInput_Base
{

public:
	enum { IDD = IDD_DLGWIZPM_RIGHTVIEWINPUT_SOLARTEMP };

	CDlgWizardPM_RightViewInput_SolarTemperature( CWizardSelPMParams *pclWizardSelPMParams, CWnd *pclParent );
...
protected:
	...
	virtual afx_msg void OnEnChangeEditSafetyTempLimiter();

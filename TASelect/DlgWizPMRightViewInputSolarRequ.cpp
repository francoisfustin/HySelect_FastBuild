...
CDlgWizardPM_RightViewInput_SolarRequirement::CDlgWizardPM_RightViewInput_SolarRequirement( CWizardSelPMParams *pclWizardSelPMParams, CWnd *pclParent )
	: CDlgWizardPM_RightViewInput_Base( pclWizardSelPMParams, SolarRequirement, IDD, pclParent )
{
...
void CDlgWizardPM_RightViewInput_SolarRequirement::ApplyPMInputUserUpdated( bool bWaterCharUpdated, bool bShowErrorMsg )
{
...
BEGIN_MESSAGE_MAP( CDlgWizardPM_RightViewInput_SolarRequirement, CDlgWizardPM_RightViewInput_Base )
...
void CDlgWizardPM_RightViewInput_SolarRequirement::DoDataExchange( CDataExchange *pDX )
{
...
BOOL CDlgWizardPM_RightViewInput_SolarRequirement::OnInitDialog()
{
	CDlgWizardPM_RightViewInput_Base::OnInitDialog();

	SetMainTitle( TASApp.LoadLocalizedString( IDS_DLGWIZPM_RVIEWSOLARREQU_MAINTITLE ) );
...
void CDlgWizardPM_RightViewInput_SolarRequirement::OnSize( UINT nType, int cx, int cy )
{
...
void CDlgWizardPM_RightViewInput_SolarRequirement::OnBnClickedGeneralCombi()
{
...
void CDlgWizardPM_RightViewInput_SolarRequirement::OnBnClickedGeneralRedundancyPump()
{
	if( NULL == m_pclWizardSelPMParams || NULL == m_pclWizardSelPMParams->m_pclSelectPMList || NULL == m_pclWizardSelPMParams->m_pclSelectPMList->GetpclPMInputUser() 
			|| NULL == m_pclWizardSelPMParams->m_pclSelectPMList->GetpclPMInputUser()->GetPMWQSelectionPreferences()  )
	{
...
void CDlgWizardPM_RightViewInput_SolarRequirement::OnBnClickedGeneralRedundancyTecBox()
{
	if( NULL == m_pclWizardSelPMParams || NULL == m_pclWizardSelPMParams->m_pclSelectPMList || NULL == m_pclWizardSelPMParams->m_pclSelectPMList->GetpclPMInputUser() 
			|| NULL == m_pclWizardSelPMParams->m_pclSelectPMList->GetpclPMInputUser()->GetPMWQSelectionPreferences()  )
	{
...
void CDlgWizardPM_RightViewInput_SolarRequirement::OnBnClickedCompBasedCoating()
{
	if( NULL == m_pclWizardSelPMParams || NULL == m_pclWizardSelPMParams->m_pclSelectPMList || NULL == m_pclWizardSelPMParams->m_pclSelectPMList->GetpclPMInputUser() 
			|| NULL == m_pclWizardSelPMParams->m_pclSelectPMList->GetpclPMInputUser()->GetPMWQSelectionPreferences()  )
	{
...
void CDlgWizardPM_RightViewInput_SolarRequirement::OnBnClickedCompBasedCompressedAir()
{
	if( NULL == m_pclWizardSelPMParams || NULL == m_pclWizardSelPMParams->m_pclSelectPMList || NULL == m_pclWizardSelPMParams->m_pclSelectPMList->GetpclPMInputUser() 
			|| NULL == m_pclWizardSelPMParams->m_pclSelectPMList->GetpclPMInputUser()->GetPMWQSelectionPreferences()  )
	{
...
void CDlgWizardPM_RightViewInput_SolarRequirement::OnBnClickedPumpDegasingBasedCoolingInsulation()
{
	if( NULL == m_pclWizardSelPMParams || NULL == m_pclWizardSelPMParams->m_pclSelectPMList || NULL == m_pclWizardSelPMParams->m_pclSelectPMList->GetpclPMInputUser() 
			|| NULL == m_pclWizardSelPMParams->m_pclSelectPMList->GetpclPMInputUser()->GetPMWQSelectionPreferences()  )
	{
...
void CDlgWizardPM_RightViewInput_SolarRequirement::_VerifyInputValues()
{

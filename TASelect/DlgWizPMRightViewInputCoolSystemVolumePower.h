...
class CDlgWizardPM_RightViewInput_CoolingSystemVolumePower : public CDlgWizardPM_RightViewInput_Base
{

public:
	enum { IDD = IDD_DLGWIZPM_RIGHTVIEWINPUT_COOLSYSTEMVOLUMEPOWER };

	CDlgWizardPM_RightViewInput_CoolingSystemVolumePower( CWizardSelPMParams *pclWizardSelPMParams, CWnd *pclParent );

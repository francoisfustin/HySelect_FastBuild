...
CDlgWizardPM_RightViewInput_SolarPMType::CDlgWizardPM_RightViewInput_SolarPMType( CWizardSelPMParams *pclWizardSelPMParams, CWnd *pclParent )
	: CDlgWizardPM_RightViewInput_Base( pclWizardSelPMParams, SolarPressurisationMaintenanceType, IDD, pclParent )
{
}

void CDlgWizardPM_RightViewInput_SolarPMType::ApplyPMInputUserUpdated( bool bWaterCharUpdated, bool bShowErrorMsg )
{
...
int CDlgWizardPM_RightViewInput_SolarPMType::IsAtLeastOneError( int &iErrorMaskNormal, int &iErrorMaskAdvanced )
{
	if( NULL == m_pclWizardSelPMParams || NULL == m_pclWizardSelPMParams->m_pclSelectPMList 
			|| NULL == m_pclWizardSelPMParams->m_pclSelectPMList->GetpclPMInputUser() )
	{
...
BEGIN_MESSAGE_MAP( CDlgWizardPM_RightViewInput_SolarPMType, CDlgWizardPM_RightViewInput_Base )
...
void CDlgWizardPM_RightViewInput_SolarPMType::DoDataExchange( CDataExchange *pDX )
{
...
BOOL CDlgWizardPM_RightViewInput_SolarPMType::OnInitDialog()
{
	if( NULL == m_pclWizardSelPMParams || NULL == m_pclWizardSelPMParams->m_pclSelectPMList 
			|| NULL == m_pclWizardSelPMParams->m_pclSelectPMList->GetpclPMInputUser() )
	{
	...
	SetMainTitle( TASApp.LoadLocalizedString( IDS_DLGWIZPM_RVIEWSOLARPMTYPE_MAINTITLE ) );
...
void CDlgWizardPM_RightViewInput_SolarPMType::OnCbnSelChangePressureMaintenanceType()
{
	if( NULL == m_pclWizardSelPMParams || NULL == m_pclWizardSelPMParams->m_pclSelectPMList 
			|| NULL == m_pclWizardSelPMParams->m_pclSelectPMList->GetpclPMInputUser() )
	{
...
void CDlgWizardPM_RightViewInput_SolarPMType::OnCbnSelChangeWaterMakeUpType()
{
	if( NULL == m_pclWizardSelPMParams || NULL == m_pclWizardSelPMParams->m_pclSelectPMList 
			|| NULL == m_pclWizardSelPMParams->m_pclSelectPMList->GetpclPMInputUser() )
	{
...
void CDlgWizardPM_RightViewInput_SolarPMType::OnEnSetFocusWaterMakeUpNetworkPN()
{
	m_ExtEditWaterMakeUpNetworkPN.SetSel( 0, -1 );
	m_dWaterMakeUpNetworkPNSaved = m_ExtEditWaterMakeUpNetworkPN.GetCurrentValSI();
}

void CDlgWizardPM_RightViewInput_SolarPMType::OnEnSetFocusWaterHardness()
{
	m_ExtEditWaterHardness.SetSel( 0, -1 );
}

void CDlgWizardPM_RightViewInput_SolarPMType::OnKillFocusWaterMakeUpNetworkPN()
{
	if( NULL == m_pclWizardSelPMParams || NULL == m_pclWizardSelPMParams->m_pclSelectPMList 
			|| NULL == m_pclWizardSelPMParams->m_pclSelectPMList->GetpclPMInputUser() )
	{
...
void CDlgWizardPM_RightViewInput_SolarPMType::OnKillFocusEditWaterHardness()
{
	if( NULL == m_pclWizardSelPMParams || NULL == m_pclWizardSelPMParams->m_pclSelectPMList 
			|| NULL == m_pclWizardSelPMParams->m_pclSelectPMList->GetpclPMInputUser() )
	{
...
void CDlgWizardPM_RightViewInput_SolarPMType::OnBnClickedDegassing()
{
	if( NULL == m_pclWizardSelPMParams || NULL == m_pclWizardSelPMParams->m_pclSelectPMList 
			|| NULL == m_pclWizardSelPMParams->m_pclSelectPMList->GetpclPMInputUser() )
	{
...
LRESULT CDlgWizardPM_RightViewInput_SolarPMType::OnUnitChange( WPARAM wParam, LPARAM lParam )
{
...
void CDlgWizardPM_RightViewInput_SolarPMType::GetExtEditList( CArray<CExtNumEdit*> &arExtEditList )
{
	arExtEditList.Add( &m_ExtEditWaterMakeUpNetworkPN );
}

void CDlgWizardPM_RightViewInput_SolarPMType::_VerifyInputValues()
{
	if( NULL == m_pclWizardSelPMParams || NULL == m_pclWizardSelPMParams->m_pclSelectPMList 
			|| NULL == m_pclWizardSelPMParams->m_pclSelectPMList->GetpclPMInputUser() )
	{

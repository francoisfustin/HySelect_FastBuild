...
class CDlgWizardPM_RightViewInput_SolarSystemVolumePower : public CDlgWizardPM_RightViewInput_Base
{

public:
	enum { IDD = IDD_DLGWIZPM_RIGHTVIEWINPUT_SOLARSYSTEMVOLUMEPOWER };

	CDlgWizardPM_RightViewInput_SolarSystemVolumePower( CWizardSelPMParams *pclWizardSelPMParams, CWnd *pclParent );

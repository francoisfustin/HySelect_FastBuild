...
class CDlgWizardPM_RightViewInput_SolarTemperatureAdvance : public CDlgWizardPM_RightViewInput_Base
{

public:
	enum { IDD = IDD_DLGWIZPM_RIGHTVIEWINPUT_SOLARTEMPADV };

	CDlgWizardPM_RightViewInput_SolarTemperatureAdvance( CWizardSelPMParams *pclWizardSelPMParams, CWnd *pclParent );

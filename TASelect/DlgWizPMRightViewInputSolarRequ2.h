...
class CDlgWizardPM_RightViewInput_SolarRequirement2 : public CDlgWizardPM_RightViewInput_Base
{

public:
	enum { IDD = IDD_DLGWIZPM_RIGHTVIEWINPUT_SOLARREQU2 };

	CDlgWizardPM_RightViewInput_SolarRequirement2( CWizardSelPMParams *pclWizardSelPMParams, CWnd *pclParent );

...
class CDlgWizardPM_RightViewInput_HeatingPressure : public CDlgWizardPM_RightViewInput_Base
{

public:
	enum { IDD = IDD_DLGWIZPM_RIGHTVIEWINPUT_HEATPRES };

	CDlgWizardPM_RightViewInput_HeatingPressure( CWizardSelPMParams *pclWizardSelPMParams, CWnd *pclParent );

...
class CDlgWizardPM_RightViewInput_CoolingSystemVolumePowerSWKI : public CDlgWizardPM_RightViewInput_Base
{

public:
	enum { IDD = IDD_DLGWIZPM_RIGHTVIEWINPUT_COOLSYSTEMVOLUMEPOWERSWKI };

	CDlgWizardPM_RightViewInput_CoolingSystemVolumePowerSWKI( CWizardSelPMParams *pclWizardSelPMParams, CWnd *pclParent );

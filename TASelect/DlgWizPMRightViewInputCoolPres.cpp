...
CDlgWizardPM_RightViewInput_CoolingPressure::CDlgWizardPM_RightViewInput_CoolingPressure( CWizardSelPMParams *pclWizardSelPMParams, CWnd *pclParent )
	: CDlgWizardPM_RightViewInput_Base( pclWizardSelPMParams, CoolingPressure, IDD, pclParent )
{
	m_bGoToAdvModeMsgSent = false;
}

void CDlgWizardPM_RightViewInput_CoolingPressure::ApplyPMInputUserUpdated( bool bWaterCharUpdated, bool bShowErrorMsg )
{
...
int CDlgWizardPM_RightViewInput_CoolingPressure::IsAtLeastOneError( int &iErrorMaskNormal, int &iErrorMaskAdvanced )
{
	...
	double dShutoffValveLocation = pclPMInputUser->GetSafetyValveLocation();
	int iError = 0;

	// Check the safety valve location.
	if( ( dShutoffValveLocation >= 0.0 && dShutoffValveLocation > pclPMInputUser->GetStaticHeight() )
		|| ( dShutoffValveLocation < 0.0 ) )
	{
...
BEGIN_MESSAGE_MAP( CDlgWizardPM_RightViewInput_CoolingPressure, CDlgWizardPM_RightViewInput_Base )
	ON_WM_LBUTTONDOWN()
...
void CDlgWizardPM_RightViewInput_CoolingPressure::DoDataExchange( CDataExchange *pDX )
{
...
BOOL CDlgWizardPM_RightViewInput_CoolingPressure::OnInitDialog()
{
	...
	str = TASApp.LoadLocalizedString( IDS_DLGWIZPM_RVIEWINPUTCOOLPRESS_PSVLOCATION );
...
void CDlgWizardPM_RightViewInput_CoolingPressure::OnPaint()
{
...
void CDlgWizardPM_RightViewInput_CoolingPressure::OnLButtonDown( UINT nFlags, CPoint point )
{
	if( false == m_bGoToAdvModeMsgSent )
	{
		...
		if( TRUE == rectGoButton.PtInRect( (POINT)point ) )
		{
			...
			m_pclParent->PostMessage( WM_USER_RIGHTVIEWWIZPM_SWITCHMODE, WPARAM( CoolingPressureAdvance ), 0 );
		}
	}
...
void CDlgWizardPM_RightViewInput_CoolingPressure::OnEnSetFocusStaticHeight()
{
	m_ExtEditStaticHeight.SetSel( 0, -1 );
	m_dStaticHeightSaved = m_ExtEditStaticHeight.GetCurrentValSI();
}

void CDlgWizardPM_RightViewInput_CoolingPressure::OnEnSetFocusPz()
{
	m_ExtEditPz.SetSel( 0, -1 );
	m_dPzSaved = m_ExtEditPz.GetCurrentValSI();
}

void CDlgWizardPM_RightViewInput_CoolingPressure::OnEnSetFocusSafetyVRP()
{
...
// HYS-1083.
void CDlgWizardPM_RightViewInput_CoolingPressure::OnEnSetFocuspSVLocation()
{
	m_EditpSVLocation.SetSel( 0, -1 );
	m_dpSVLocationSaved = m_EditpSVLocation.GetCurrentValSI();
}

void CDlgWizardPM_RightViewInput_CoolingPressure::OnEnChangeStaticHeight()
{
	if( NULL == m_pclWizardSelPMParams || NULL == m_pclWizardSelPMParams->m_pclSelectPMList 
			|| NULL == m_pclWizardSelPMParams->m_pclSelectPMList->GetpclPMInputUser() )
	{
...
void CDlgWizardPM_RightViewInput_CoolingPressure::OnKillFocusStaticHeight()
{
	if( NULL == m_pclWizardSelPMParams || NULL == m_pclWizardSelPMParams->m_pclSelectPMList 
			|| NULL == m_pclWizardSelPMParams->m_pclSelectPMList->GetpclPMInputUser() )
	{
	...
	// Static height has an influence on safety valve location error.
...
void CDlgWizardPM_RightViewInput_CoolingPressure::OnKillFocusPz()
{
	if( NULL == m_pclWizardSelPMParams || NULL == m_pclWizardSelPMParams->m_pclSelectPMList 
			|| NULL == m_pclWizardSelPMParams->m_pclSelectPMList->GetpclPMInputUser() )
	{
...
void CDlgWizardPM_RightViewInput_CoolingPressure::OnKillFocusSafetyVRP()
{
	if( NULL == m_pclWizardSelPMParams || NULL == m_pclWizardSelPMParams->m_pclSelectPMList 
			|| NULL == m_pclWizardSelPMParams->m_pclSelectPMList->GetpclPMInputUser() )
	{
...
// HYS-1083.
void CDlgWizardPM_RightViewInput_CoolingPressure::OnKillFocuspSVLocation()
{
	if( NULL == m_pclWizardSelPMParams || NULL == m_pclWizardSelPMParams->m_pclSelectPMList
		|| NULL == m_pclWizardSelPMParams->m_pclSelectPMList->GetpclPMInputUser() )
	{
...
void CDlgWizardPM_RightViewInput_CoolingPressure::OnBnClickedCheckPz()
{
...
void CDlgWizardPM_RightViewInput_CoolingPressure::UpdateP0()
{
	if( NULL == m_pclWizardSelPMParams || NULL == m_pclWizardSelPMParams->m_pclSelectPMList ||
			NULL == m_pclWizardSelPMParams->m_pclSelectPMList->GetpclPMInputUser() )
	{
...
void CDlgWizardPM_RightViewInput_CoolingPressure::OnBnClickedCheckpSVLocation()
{
	if( NULL == m_pclWizardSelPMParams || NULL == m_pclWizardSelPMParams->m_pclSelectPMList
		|| NULL == m_pclWizardSelPMParams->m_pclSelectPMList->GetpclPMInputUser() )
	{
...
LRESULT CDlgWizardPM_RightViewInput_CoolingPressure::OnUnitChange( WPARAM wParam, LPARAM lParam )
{
...
void CDlgWizardPM_RightViewInput_CoolingPressure::GetExtEditList( CArray<CExtNumEdit*> &arExtEditList )
{
...
void CDlgWizardPM_RightViewInput_CoolingPressure::_VerifyInputValues()
{
	CheckPz( &m_BtnCheckPz, &m_ExtEditPz );
	CheckSafetyVRP( &m_ExtEditSafetyVRP, &m_StaticSafetyVRPMinimum );
	// Check the safety valve location.

...
class CDlgWizardPM_RightViewInput_CoolingRequirement : public CDlgWizardPM_RightViewInput_Base
{

public:
	enum { IDD = IDD_DLGWIZPM_RIGHTVIEWINPUT_HEATREQU };

	CDlgWizardPM_RightViewInput_CoolingRequirement( CWizardSelPMParams *pclWizardSelPMParams, CWnd *pclParent );

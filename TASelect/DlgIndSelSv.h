...
class CDlgIndSelSv : public CDlgIndSelBase
{
public:
	enum { IDD = IDD_DLGINDSELSV };

	CDlgIndSelSv( CWnd *pParent = NULL );
	virtual ~CDlgIndSelSv() {}
	...
	CExtNumEditComboBox *GetpComboFamily() { return &m_ComboFamily; }
	CExtNumEditComboBox *GetpComboBdyMat() { return &m_ComboBdyMat; }
	CExtNumEditComboBox *GetpComboConnect() { return &m_ComboConnect; }
	CExtNumEditComboBox *GetpComboVersion() { return &m_ComboVersion; }
	CExtNumEditComboBox *GetpComboPN()	{ return &m_ComboPN; }
...
protected:
	...
	afx_msg LRESULT OnModifySelectedSv( WPARAM wParam, LPARAM lParam );
	...
	virtual CString GetDlgCaption(){ return TASApp.LoadLocalizedString(IDS_LEFTTABTITLE_SHUTOFFVALVE); }
...
private:
	...
	void _LaunchSuggestion( CString strTypeID, CString strFamilyID, CString strMaterialID, CString strConnectID, CString strVersionID, CString strPNID );

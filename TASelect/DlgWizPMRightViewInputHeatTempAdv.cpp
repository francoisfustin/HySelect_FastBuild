...
CDlgWizardPM_RightViewInput_HeatingTemperatureAdvance::CDlgWizardPM_RightViewInput_HeatingTemperatureAdvance( CWizardSelPMParams *pclWizardSelPMParams, CWnd *pclParent )
	: CDlgWizardPM_RightViewInput_Base( pclWizardSelPMParams, HeatingTemperatureAdvance, IDD, pclParent )
{
	m_bGoToNormalModeMsgSent = false;
}

void CDlgWizardPM_RightViewInput_HeatingTemperatureAdvance::ApplyPMInputUserUpdated( bool bWaterCharUpdated, bool bShowErrorMsg )
{
	...
	bool bAtLeastOneTempChange = bWaterCharUpdated;
	...
	// Must be done when all temperature fields are filled.
	...
	if( true == bAtLeastOneTempChange )
	{
		_VerifyInputValues( bShowErrorMsg );
	}
}

int CDlgWizardPM_RightViewInput_HeatingTemperatureAdvance::IsAtLeastOneError( int &iErrorMaskNormal, int &iErrorMaskAdvanced )
{
...
BEGIN_MESSAGE_MAP( CDlgWizardPM_RightViewInput_HeatingTemperatureAdvance, CDlgWizardPM_RightViewInput_Base )
	ON_WM_LBUTTONDOWN()
...
void CDlgWizardPM_RightViewInput_HeatingTemperatureAdvance::DoDataExchange( CDataExchange *pDX )
{
...
BOOL CDlgWizardPM_RightViewInput_HeatingTemperatureAdvance::OnInitDialog()
{
	...
	// Supply temperature:
	str = TASApp.LoadLocalizedString( IDS_DLGWIZPM_RVIEWINPUTHEATTEMP_SUPPLYTEMP );
	...
	// Return temperature:
	str = TASApp.LoadLocalizedString( IDS_DLGWIZPM_RVIEWINPUTHEATTEMP_RETURNTEMP );
	...
	str = TASApp.LoadLocalizedString( IDS_DLGWIZPM_RVIEWINPUTHEATTEMP_MINTEMP );
	...
	str = TASApp.LoadLocalizedString( IDS_DLGWIZPM_RVIEWINPUTHEATTEMP_WC );
...
void CDlgWizardPM_RightViewInput_HeatingTemperatureAdvance::OnPaint()
{
...
void CDlgWizardPM_RightViewInput_HeatingTemperatureAdvance::OnLButtonDown( UINT nFlags, CPoint point )
{
	if( false == m_bGoToNormalModeMsgSent )
	{
		...
		if( TRUE == rectGoButton.PtInRect( (POINT)point ) )
		{
			...
			m_pclParent->PostMessage( WM_USER_RIGHTVIEWWIZPM_SWITCHMODE, WPARAM( HeatingTemperature ), 0 );
		}
	}
...
void CDlgWizardPM_RightViewInput_HeatingTemperatureAdvance::OnCbnSelChangeNorm()
{
	if( NULL == m_pclWizardSelPMParams || NULL == m_pclWizardSelPMParams->m_pclSelectPMList 
			|| NULL == m_pclWizardSelPMParams->m_pclSelectPMList->GetpclPMInputUser() )
	{
	...
	// Check if errors.
	int iErrorCode = AreHeatingSolarTemperaturesOK( &m_ExtEditSafetyTempLimiter, &m_ExtEditSupplyTemp, &m_ExtEditReturnTemp, &m_ExtEditMinTemp, &m_ExtEditFillTemp, &m_ComboNorm );
...
void CDlgWizardPM_RightViewInput_HeatingTemperatureAdvance::OnEnSetFocusSafetyTempLimiter()
{
	m_ExtEditSafetyTempLimiter.SetSel( 0, -1 );
	m_dSafetyTempLimiterSaved = m_ExtEditSafetyTempLimiter.GetCurrentValSI();
}

void CDlgWizardPM_RightViewInput_HeatingTemperatureAdvance::OnEnSetFocusSupplyTemp()
{
	m_ExtEditSupplyTemp.SetSel( 0, -1 );
	m_dSupplyTempSaved = m_ExtEditSupplyTemp.GetCurrentValSI();
}

void CDlgWizardPM_RightViewInput_HeatingTemperatureAdvance::OnEnSetFocusReturnTemp()
{
	m_ExtEditReturnTemp.SetSel( 0, -1 );
	m_dReturnTempSaved = m_ExtEditReturnTemp.GetCurrentValSI();
}

void CDlgWizardPM_RightViewInput_HeatingTemperatureAdvance::OnEnSetFocusMinTemp()
{
	m_ExtEditMinTemp.SetSel( 0, -1 );
	m_dMinTempSaved = m_ExtEditMinTemp.GetCurrentValSI();
}

void CDlgWizardPM_RightViewInput_HeatingTemperatureAdvance::OnEnSetFocusFillTemp()
{
	m_ExtEditFillTemp.SetSel( 0, -1 );
	m_dFillTempSaved = m_ExtEditFillTemp.GetCurrentValSI();
}

void CDlgWizardPM_RightViewInput_HeatingTemperatureAdvance::OnKillFocusEditSafetyTempLimiter()
{
...
void CDlgWizardPM_RightViewInput_HeatingTemperatureAdvance::OnKillFocusEditSupplyTemp()
{
	// Do nothing if no changed.
...
void CDlgWizardPM_RightViewInput_HeatingTemperatureAdvance::OnKillFocusEditReturnTemp()
{
	// Do nothing if no changed.
...
void CDlgWizardPM_RightViewInput_HeatingTemperatureAdvance::OnKillFocusEditMinTemp()
{
	// Do nothing if no changed.
...
void CDlgWizardPM_RightViewInput_HeatingTemperatureAdvance::OnKillFocusEditFillTemp()
{
	// Do nothing if no changed.
...
void CDlgWizardPM_RightViewInput_HeatingTemperatureAdvance::OnBnClickedWaterChar()
{
...
LRESULT CDlgWizardPM_RightViewInput_HeatingTemperatureAdvance::OnUnitChange( WPARAM wParam, LPARAM lParam )
{
...
void CDlgWizardPM_RightViewInput_HeatingTemperatureAdvance::GetExtEditList( CArray<CExtNumEdit*> &arExtEditList )
{
...
void CDlgWizardPM_RightViewInput_HeatingTemperatureAdvance::InitToolTips( CWnd *pWnd )
{
...
void CDlgWizardPM_RightViewInput_HeatingTemperatureAdvance::_VerifyInputValues( bool bShowErrorMsg )
{
	AreHeatingSolarTemperaturesOK( &m_ExtEditSafetyTempLimiter, &m_ExtEditSupplyTemp, &m_ExtEditReturnTemp, &m_ExtEditMinTemp, &m_ExtEditFillTemp, &m_ComboNorm, bShowErrorMsg );
}

...
class CDlgWizardPM_RightViewInput_SolarRequirement : public CDlgWizardPM_RightViewInput_Base
{

public:
	enum { IDD = IDD_DLGWIZPM_RIGHTVIEWINPUT_SOLARREQU };

	CDlgWizardPM_RightViewInput_SolarRequirement( CWizardSelPMParams *pclWizardSelPMParams, CWnd *pclParent );

...
public:
	...
	BOOL		 FixColumnSize			(int nCol, BOOL bOn=TRUE);
	...
	// IMI Hydronic Engineering methods.
	TreeListData* TAGetTreeListData		();
	BOOL		 TAEnsureVisible		( TAEnsureVisibleParam* pParam );
	BOOL		 TAGetItemRect			( TAGetItemRectParam* pParam );
	BOOL		 TASetVAlternateColor	( TASetVAlternateColorParam* pParam );
	BOOL		 TASetItemStateEx       ( HTREEITEM hItem, UINT uiStateEx );
...
inline	BOOL		 CTreeListCtrl::GetItemRect(HTREEITEM hItem,RECT *pRect,int iCode)			{ return CTreeCtrl::GetItemRect(hItem,pRect,iCode); }
...
// IMI Hydronic Engineering: special functions added for us.
inline	TreeListData* CTreeListCtrl::TAGetTreeListData()										{ ASSERT(::IsWindow(m_hWnd)); return TATreeList_GetTreeListData(m_hWnd); }
inline	BOOL		 CTreeListCtrl::TAEnsureVisible( TAEnsureVisibleParam* pParam )				{ ASSERT(::IsWindow(m_hWnd)); return TATreeList_EnsureVisible( m_hWnd, pParam ); }
inline	BOOL		 CTreeListCtrl::TAGetItemRect( TAGetItemRectParam* pParam )					{ ASSERT(::IsWindow(m_hWnd)); return TATreeList_GetItemRect( m_hWnd, pParam ); }
inline	BOOL		 CTreeListCtrl::TASetVAlternateColor( TASetVAlternateColorParam* pParam )	{ ASSERT(::IsWindow(m_hWnd)); return TATreeList_SetVAlternateColor( m_hWnd, pParam ); }
inline  BOOL		 CTreeListCtrl::TASetItemStateEx( HTREEITEM hItem, UINT uiStateEx )			{ return SetItemStateEx( hItem, uiStateEx ); }
// ListCtrl Functions
...
inline	INT 		 CTreeListCtrl::ListGetItemData     (int iRow                              ){ return GetItemData     (GetItemOfRow(iRow)                  );}		

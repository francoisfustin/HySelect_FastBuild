...
public:
	...
	void FireScriptOLEGiveFeedback(VARIANT FAR * Effect, VARIANT FAR * DefaultCursors)
		{FireEvent(eventidScriptOLEGiveFeedback,EVENT_PARAM(VTS_PVARIANT  VTS_PVARIANT), Effect, DefaultCursors);}

	void FireScriptOLECompleteDrag(VARIANT FAR * Effect)
		{FireEvent(eventidScriptOLECompleteDrag,EVENT_PARAM(VTS_PVARIANT), Effect);}
...
//		{FireEvent(eventidScriptOLEDragDrop,EVENT_PARAM(VTS_PDISPATCH  VTS_PVARIANT  VTS_PI2  VTS_PI2 VTS_PR4 VTS_PR4), DataObject, Effect, Button, Shift, X, Y);}
	void FireScriptOLEDragDrop(VARIANT FAR * DataObject, VARIANT FAR * Effect, VARIANT FAR * Button, VARIANT FAR * Shift, VARIANT FAR * X, VARIANT FAR * Y)
		{FireEvent(eventidScriptOLEDragDrop,EVENT_PARAM(VTS_PVARIANT  VTS_PVARIANT  VTS_PVARIANT  VTS_PVARIANT VTS_PVARIANT VTS_PVARIANT), DataObject, Effect, Button, Shift, X, Y);}
...
//		{FireEvent(eventidScriptOLEDragOver,EVENT_PARAM(VTS_PDISPATCH  VTS_PVARIANT  VTS_PI2  VTS_PI2 VTS_PR4 VTS_PR4  VTS_PI2), DataObject,  Effect, Button, Shift, X, Y, State);}
	void FireScriptOLEDragOver(VARIANT FAR * DataObject, VARIANT FAR * Effect, VARIANT FAR * Button, VARIANT FAR * Shift, VARIANT FAR * X, VARIANT FAR * Y, VARIANT FAR * State)
		{FireEvent(eventidScriptOLEDragOver,EVENT_PARAM(VTS_PVARIANT  VTS_PVARIANT  VTS_PVARIANT  VTS_PVARIANT VTS_PVARIANT VTS_PVARIANT  VTS_PVARIANT), DataObject,  Effect, Button, Shift, X, Y, State);}

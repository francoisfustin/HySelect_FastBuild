...
public:
	void FireOLECompleteDrag(long* Effect)
		{if (m_bEventEnabled[EventEnabled_OLECompleteDrag]) FireEvent(eventidOLECompleteDrag,EVENT_PARAM(VTS_PI4), Effect);}
	
	void FireOLEDragDrop(CfpDataObject** DataObject, long* Effect, short* Button, short* Shift, float* X, float* Y)
		{if (m_bEventEnabled[EventEnabled_OLEDragDrop]) FireEvent(eventidOLEDragDrop,EVENT_PARAM(VTS_PDISPATCH  VTS_PI4  VTS_PI2  VTS_PI2 VTS_PR4 VTS_PR4), DataObject, Effect, Button, Shift, X, Y);}
	
	void FireOLEDragOver(CfpDataObject** DataObject, long* Effect, short* Button, short* Shift, float* X, float* Y, short* State)
		{if (m_bEventEnabled[EventEnabled_OLEDragOver]) FireEvent(eventidOLEDragOver,EVENT_PARAM(VTS_PDISPATCH  VTS_PI4  VTS_PI2  VTS_PI2 VTS_PR4 VTS_PR4  VTS_PI2), DataObject,  Effect, Button, Shift, X, Y, State);}
	
	void FireOLEGiveFeedback(long* Effect, BOOL* DefaultCursors)
		{if (m_bEventEnabled[EventEnabled_OLEGiveFeedback]) FireEvent(eventidOLEGiveFeedback,EVENT_PARAM(VTS_PI4  VTS_PBOOL), Effect, DefaultCursors);}
	void FireOLESetData(CfpDataObject** DataObject, short* Format)
		{if (m_bEventEnabled[EventEnabled_OLESetData]) FireEvent(eventidOLESetData,EVENT_PARAM(VTS_PDISPATCH  VTS_PI2), DataObject, Format);}
	void FireOLEStartDrag(CfpDataObject** DataObject, long* AllowedEffects)
		{if (m_bEventEnabled[EventEnabled_OLEStartDrag]) FireEvent(eventidOLEStartDrag,EVENT_PARAM(VTS_PDISPATCH  VTS_PI4), DataObject, AllowedEffects);}

#ifdef SS_V35
	void FireScriptOLEGiveFeedback(VARIANT FAR * Effect, VARIANT FAR * DefaultCursors)
		{if (m_bEventEnabled[EventEnabled_OLEGiveFeedback]) FireEvent(eventidScriptOLEGiveFeedback,EVENT_PARAM(VTS_PVARIANT  VTS_PVARIANT), Effect, DefaultCursors);}

	void FireScriptOLECompleteDrag(VARIANT FAR * Effect)
		{if (m_bEventEnabled[EventEnabled_OLECompleteDrag]) FireEvent(eventidScriptOLECompleteDrag,EVENT_PARAM(VTS_PVARIANT), Effect);}
	
//	void FireScriptOLEDragDrop(CfpDataObject** DataObject, VARIANT FAR * Effect, short* Button, short* Shift, float* X, float* Y)
//		{FireEvent(eventidScriptOLEDragDrop,EVENT_PARAM(VTS_PDISPATCH  VTS_PVARIANT  VTS_PI2  VTS_PI2 VTS_PR4 VTS_PR4), DataObject, Effect, Button, Shift, X, Y);}
//	void FireScriptOLEDragDrop(VARIANT FAR * DataObject, VARIANT FAR * Effect, short* Button, short* Shift, float* X, float* Y)
//		{FireEvent(eventidScriptOLEDragDrop,EVENT_PARAM(VTS_PVARIANT  VTS_PVARIANT  VTS_PI2  VTS_PI2 VTS_PR4 VTS_PR4), DataObject, Effect, Button, Shift, X, Y);}
	void FireScriptOLEDragDrop(VARIANT FAR * DataObject, VARIANT FAR * Effect, VARIANT FAR * Button, VARIANT FAR * Shift, VARIANT FAR * X, VARIANT FAR * Y)
		{if (m_bEventEnabled[EventEnabled_OLEDragDrop]) FireEvent(eventidScriptOLEDragDrop,EVENT_PARAM(VTS_PVARIANT  VTS_PVARIANT  VTS_PVARIANT  VTS_PVARIANT VTS_PVARIANT VTS_PVARIANT), DataObject, Effect, Button, Shift, X, Y);}
	
//	void FireScriptOLEDragOver(CfpDataObject** DataObject, VARIANT FAR * Effect, short* Button, short* Shift, float* X, float* Y, short* State)
//		{FireEvent(eventidScriptOLEDragOver,EVENT_PARAM(VTS_PDISPATCH  VTS_PVARIANT  VTS_PI2  VTS_PI2 VTS_PR4 VTS_PR4  VTS_PI2), DataObject,  Effect, Button, Shift, X, Y, State);}
//	void FireScriptOLEDragOver(VARIANT FAR * DataObject, VARIANT FAR * Effect, short* Button, short* Shift, float* X, float* Y, short* State)
//		{FireEvent(eventidScriptOLEDragOver,EVENT_PARAM(VTS_PVARIANT  VTS_PVARIANT  VTS_PI2  VTS_PI2 VTS_PR4 VTS_PR4  VTS_PI2), DataObject,  Effect, Button, Shift, X, Y, State);}
	void FireScriptOLEDragOver(VARIANT FAR * DataObject, VARIANT FAR * Effect, VARIANT FAR * Button, VARIANT FAR * Shift, VARIANT FAR * X, VARIANT FAR * Y, VARIANT FAR * State)
		{if (m_bEventEnabled[EventEnabled_OLEDragOver]) FireEvent(eventidScriptOLEDragOver,EVENT_PARAM(VTS_PVARIANT  VTS_PVARIANT  VTS_PVARIANT  VTS_PVARIANT VTS_PVARIANT VTS_PVARIANT  VTS_PVARIANT), DataObject,  Effect, Button, Shift, X, Y, State);}
	
//	void FireScriptOLEStartDrag(CfpDataObject** DataObject, VARIANT FAR * AllowedEffects)
//		{FireEvent(eventidScriptOLEStartDrag,EVENT_PARAM(VTS_PDISPATCH  VTS_PVARIANT), DataObject, AllowedEffects);}
	void FireScriptOLEStartDrag(VARIANT FAR * DataObject, VARIANT FAR * AllowedEffects)
		{FireEvent(eventidScriptOLEStartDrag,EVENT_PARAM(VTS_PVARIANT  VTS_PVARIANT), DataObject, AllowedEffects);}
#endif // SS_V35

...
void jpeg_set_linear_quality (j_compress_ptr cinfo, int scale_factor, BOOL force_baseline)
...
void jpeg_set_quality (j_compress_ptr cinfo, int quality, BOOL force_baseline)
/* Set or change the 'quality' (quantization) setting, using default tables.

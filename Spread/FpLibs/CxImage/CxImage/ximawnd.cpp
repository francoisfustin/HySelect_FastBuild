...
////////////////////////////////////////////////////////////////////////////////
long CxImage::DrawText(HDC hdc, long x, long y, LPCTSTR text, RGBQUAD color, LPCTSTR font, long lSize, long lWeight, BYTE bItalic, BYTE bUnderline, bool bEditAlpha)
{
	if (IsValid()){
		//get the background
		HDC TmpDC=CreateCompatibleDC(hdc);
		...
		_tcsncpy(m_pLF->lfFaceName,font,31);

...
// GAB - Removed at Sean's request. We're not going to support these formats
...
#if defined(__cplusplus) && !defined(IGNORE_CLASSES)
#include "xfile.h"
#include "xiofile.h"
#include "xmemfile.h"
#endif
...
/*
	...
	long	DrawText(HDC hdc, long x, long y, LPCTSTR text, RGBQUAD color, LPCTSTR font, long lSize=0, long lWeight=400, BYTE bItalic=0, BYTE bUnderline=0, bool bEditAlpha=false);
*/
...
#endif
  // adding support for these methods even though transformations
  // are turned off, for use in FPIMAGES.CPP -scl
...
#endif // __cplusplus && !IGNORE_CLASSES
////////////////////////////////////////////////////////////////////////////

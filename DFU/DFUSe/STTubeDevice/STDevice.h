...
{
public:	
	CSTDevice(CStringA sSymbolicName);
	~CSTDevice();
public:
	// Connection state
	DWORD Open(PHANDLE);
	...
	// - String descriptors
	DWORD GetStringDescriptor(UINT Index, CStringA &Desc);
	// - Device descriptors
	...
	CStringA GetSymbolicName() { return m_SymbolicName; }

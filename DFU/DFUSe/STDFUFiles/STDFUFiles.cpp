...
void STDFUFiles_Init()
{
}

void STDFUFiles_DeInit()
{
	int i;
	for (i=0;i<=g_Images.GetUpperBound();i++)
	{
...
DWORD STDFUFILES_OpenExistingDFUFile(PSTR pPathFile, 
									PHANDLE phFile, 
									PWORD pVid, 
									PWORD pPid, 
									PWORD pBcd,
...
DWORD STDFUFILES_CreateNewDFUFile(PSTR pPathFile,
						            PHANDLE phFile, 
									WORD Vid,
									WORD Pid,
									WORD Bcd)
...
DWORD STDFUFILES_ReadImageFromDFUFile(HANDLE hFile, 
									int Rank, 
									PHANDLE pImage)
{
//	AFX_MANAGE_STATE(AfxGetStaticModuleState());
...
DWORD STDFUFILES_GetImageAlternate(HANDLE Image, PBYTE pAlternate)
{
//	AFX_MANAGE_STATE(AfxGetStaticModuleState());
...
DWORD STDFUFILES_GetImageName(HANDLE Image, PSTR Name)
{
//	AFX_MANAGE_STATE(AfxGetStaticModuleState());
...
DWORD STDFUFILES_SetImageName(HANDLE Image, PSTR Name)
{
	//AFX_MANAGE_STATE(AfxGetStaticModuleState());

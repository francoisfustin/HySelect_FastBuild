...
private:
	...
	void		LDisplayError(PSTR Str) { lstrcpyA(m_LastError, Str); }
...
public:
	...
	BOOL	GetName(PSTR Name) { if (m_bNamed) lstrcpyA(Name, m_Name); return m_bNamed; } 
	void    SetName(PSTR Name) { lstrcpyA(m_Name, Name); m_bNamed=TRUE; }
